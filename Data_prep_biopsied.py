...
train, test = train_test_split(grouped_list, test_size=0.5, random_state=41)
...
# Export to CSV
all_df.to_csv('../disc_research_images/gen/biopsied/patient_lesion/5050/patient_lesion_groups.csv', index=False)
...
np.save('../disc_research_images/gen/biopsied/patient_lesion/5050/X_train.npy', X_train)
np.save('../disc_research_images/gen/biopsied/patient_lesion/5050/y_train.npy', Y_train)
#np.save('../disc_research_images/gen/suspicious/X_val.npy', X_val)
#np.save('../disc_research_images/gen/suspicious/Y_val.npy', Y_val)
np.save('../disc_research_images/gen/biopsied/patient_lesion/5050/X_test.npy', X_test)
np.save('../disc_research_images/gen/biopsied/patient_lesion/5050/y_test.npy', Y_test)
